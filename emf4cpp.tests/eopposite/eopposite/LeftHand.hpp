...
protected:
    LeftHand_ptr _this()
    {   return std::dynamic_pointer_cast<LeftHand>(shared_from_this());}

    // Attributes

    // References

    std::weak_ptr< ::eopposite::RightHand > m_rightee;

    std::weak_ptr< ::eopposite::RightMultiple > m_rightMultiple;
