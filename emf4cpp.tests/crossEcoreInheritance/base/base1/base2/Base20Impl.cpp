...
/*
 * base/base1/base2/Base20Impl.cpp
...
/*PROTECTED REGION ID(Base20Impl.cpp) START*/
...
void Base20::_initialize()
{
    // Supertypes
    ::base::base1::Base10::_initialize();
    ::base::base1::Base11::_initialize();

    // References

    /*PROTECTED REGION ID(Base20Impl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject Base20::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ::ecore::EJavaObject _any;
    switch (_featureID)
    {
    case ::base::base1::base2::Base2Package::BASE20__VALBASE01:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getValBase01());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__DERIVED02REF:
    {
        _any = ::ecore::as < ::ecore::EObject > (getDerived02ref());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__VALBASE10:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getValBase10());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__VALBASE02:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getValBase02());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__VALBASE03:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getValBase03());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__VALBASE11:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getValBase11());
    }
        return _any;
    case ::base::base1::base2::Base2Package::BASE20__VALBASE20:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
 ...
 */
void Base20::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Base20::_inverseRemove(::ecore::EInt _featureID,
