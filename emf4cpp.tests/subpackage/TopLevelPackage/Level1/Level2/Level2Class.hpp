...
namespace TopLevelPackage
{
    namespace Level1
    {
        ...
        public:
            ...
            static const int classifierId = Level2Package::LEVEL2CLASS;

            /*PROTECTED REGION ID(Level2Class) START*/
            // Please, enable the protected region if you add manually written code.
            // To do this, add the keyword ENABLED before START.
            /*PROTECTED REGION END*/
            ...
            /*PROTECTED REGION ID(Level2ClassImpl) START*/
            // Please, enable the protected region if you add manually written code.
            // To do this, add the keyword ENABLED before START.
            /*PROTECTED REGION END*/

        protected:
            Level2Class_ptr _this()
            {   return std::dynamic_pointer_cast<Level2Class>(shared_from_this());}
...
#endif // TOPLEVELPACKAGE_LEVEL1_LEVEL2_LEVEL2CLASS_HPP
