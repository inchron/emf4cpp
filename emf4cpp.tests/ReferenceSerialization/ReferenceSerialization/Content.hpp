...
#ifndef REFERENCESERIALIZATION_CONTENT_HPP
#define REFERENCESERIALIZATION_CONTENT_HPP
...
class EXPORT_REFERENCESERIALIZATION_DLL Content : public virtual ::ecore::EObject
{
public:
    Content();
    ...
    static const int classifierId = ReferenceSerializationPackage::CONTENT;

    /*PROTECTED REGION ID(Content) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
    ...
    /*PROTECTED REGION ID(ContentImpl) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
...
#endif // REFERENCESERIALIZATION_CONTENT_HPP
