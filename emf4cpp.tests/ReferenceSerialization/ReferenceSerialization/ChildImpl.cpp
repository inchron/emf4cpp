...
/*PROTECTED REGION ID(ChildImpl.cpp) START*/
...
void Child::_initialize()
{
    // Supertypes

    // References

    /*PROTECTED REGION ID(ChildImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
 ...
 */
void Child::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Child::_inverseRemove(::ecore::EInt _featureID,
