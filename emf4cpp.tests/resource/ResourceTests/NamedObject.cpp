...
/*PROTECTED REGION ID(NamedObject.cpp) START*/
...
::ecore::EString const& NamedObject::getName() const
{
    return m_name;
}
...
void NamedObject::setName(::ecore::EString const &_name)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::ResourceTests::ResourceTestsPackage::_instance()->getNamedObject__name(),
                _old_name,
                m_name
            );
