...
/*PROTECTED REGION ID(ReferenceTargetImpl.cpp) START*/
...
void ReferenceTarget::_initialize()
{
    // Supertypes

    // References

    /*PROTECTED REGION ID(ReferenceTargetImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject ReferenceTarget::eGet(::ecore::EInt _featureID,
 ...
 */
void ReferenceTarget::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void ReferenceTarget::_inverseRemove(::ecore::EInt _featureID,
