...
namespace xpand3
{
    ...
    class EXPORT_XPAND3_DLL DefinitionAspect : public virtual ::xpand3::declaration::AbstractAspect
    {
    public:
        DefinitionAspect();

        ~DefinitionAspect() override;
        ...
        static const int classifierId = DeclarationPackage::DEFINITIONASPECT;
