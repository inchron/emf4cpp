...
/*PROTECTED REGION ID(RealLiteralImpl.cpp) START*/
...
// EObject
::ecore::EJavaObject RealLiteral::eGet(::ecore::EInt _featureID,
...
void RealLiteral::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean RealLiteral::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::xpand3::expression::ExpressionPackage::REALLITERAL__LINE:
...
void RealLiteral::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void RealLiteral::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void RealLiteral::_inverseRemove(::ecore::EInt _featureID,
