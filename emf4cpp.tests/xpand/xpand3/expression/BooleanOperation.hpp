...
namespace xpand3
{
    ...
    class EXPORT_XPAND3_DLL BooleanOperation : public virtual ::xpand3::expression::BinaryOperation
    {
    public:
        BooleanOperation();

        ~BooleanOperation() override;
        ...
        static const int classifierId = ExpressionPackage::BOOLEANOPERATION;

        /*PROTECTED REGION ID(BooleanOperation) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
        ...
        /*PROTECTED REGION ID(BooleanOperationImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // XPAND3_EXPRESSION_BOOLEANOPERATION_HPP
