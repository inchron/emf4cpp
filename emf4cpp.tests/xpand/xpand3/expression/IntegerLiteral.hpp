...
/*PROTECTED REGION ID(IntegerLiteral_pre) START*/
...
namespace xpand3
{
    ...
    class EXPORT_XPAND3_DLL IntegerLiteral : public virtual ::xpand3::expression::Literal
    {
    public:
        IntegerLiteral();
        ...
        static const int classifierId = ExpressionPackage::INTEGERLITERAL;
        ...
        /*PROTECTED REGION ID(IntegerLiteralImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
