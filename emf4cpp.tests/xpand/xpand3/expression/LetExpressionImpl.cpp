        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__LINE:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getLine());
    }
        return _any;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__START:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getStart());
    }
        return _any;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__END:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getEnd());
    }
        return _any;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__FILENAME:
    {
    ...
    {
        _any = ::ecore::as < ::ecore::EObject > (getVarExpression());
    }
        return _any;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__TARGETEXPRESSION:
    {
        _any = ::ecore::as < ::ecore::EObject > (getTargetExpression());
    }
        return _any;
...
::ecore::EBoolean LetExpression::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__FILENAME:
        return ::ecorecpp::mapping::set_traits < ::ecore::EString
                > ::is_set(getFileName());
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__VAREXPRESSION:
        return getVarExpression().get() != nullptr;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__TARGETEXPRESSION:
        return getTargetExpression().get() != nullptr;
    case ::xpand3::expression::ExpressionPackage::LETEXPRESSION__VARNAME:
...
::ecore::EClass_ptr LetExpression::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::xpand3::expression::ExpressionPackage::_instance()->getLetExpression();
    return _eclass;
}
