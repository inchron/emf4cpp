...
namespace xpand3
{
    ...
    class EXPORT_XPAND3_DLL AbstractExpression : public virtual ::xpand3::SyntaxElement
    {
    public:
        AbstractExpression();
        ...
        /*PROTECTED REGION ID(AbstractExpressionImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // XPAND3_EXPRESSION_ABSTRACTEXPRESSION_HPP
