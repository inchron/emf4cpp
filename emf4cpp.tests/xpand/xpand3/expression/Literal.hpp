...
namespace xpand3
{
    ...
    class EXPORT_XPAND3_DLL Literal : public virtual ::xpand3::expression::AbstractExpression
    {
    public:
        Literal();
        ...
        // References
        virtual ::xpand3::Identifier_ptr getLiteralValue () const;
        virtual void setLiteralValue (::xpand3::Identifier_ptr _literalValue);

        /* This is the same value as getClassifierId() returns, but as a static
         * value it can be used in template expansions. */
        static const int classifierId = ExpressionPackage::LITERAL;
