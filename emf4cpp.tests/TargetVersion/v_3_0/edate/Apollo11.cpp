...
void Apollo11::setFirstManOnMoonDate(::ecore::EDate _FirstManOnMoonDate)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::v_3_0::edate::EdatePackage::_instance()->getApollo11__FirstManOnMoonDate(),
...
::v_3_0::edate::Person_ptr Apollo11::getMember() const
{
    return m_Member;
}

void Apollo11::setMember(::v_3_0::edate::Person_ptr _Member)
{
    if (m_Member)
        m_Member->_setEContainer(Apollo11_ptr(),
                ::v_3_0::edate::EdatePackage::_instance()->getApollo11__Member());
    if (_Member)
        _Member->_setEContainer(_this(),
                ::v_3_0::edate::EdatePackage::_instance()->getApollo11__Member());

#ifdef ECORECPP_NOTIFICATION_API
    ::v_3_0::edate::Person_ptr _old_Member = m_Member;
#endif
    m_Member = _Member;
