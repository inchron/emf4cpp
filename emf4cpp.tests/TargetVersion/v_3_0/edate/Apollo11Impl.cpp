        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::v_3_0::edate::EdatePackage::APOLLO11__FIRSTMANONMOONDATE:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EDate
                > ::toAny(_any, getFirstManOnMoonDate());
    }
        return _any;
    case ::v_3_0::edate::EdatePackage::APOLLO11__MEMBER:
    {
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::v_3_0::edate::EdatePackage::APOLLO11__MEMBER:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::v_3_0::edate::Person > (_t0);
        setMember(_t1);
    }
        return;
...
::ecore::EClass_ptr Apollo11::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::v_3_0::edate::EdatePackage::_instance()->getApollo11();
    return _eclass;
}
