...
#ifndef _V_1_0_EDATEPACKAGE_HPP
#define _V_1_0_EDATEPACKAGE_HPP
...
namespace v_1_0
{
    ...
    class EXPORT_V_1_0_EDATE_DLL EdatePackage : public virtual ::ecore::EPackage
    {
    public:
