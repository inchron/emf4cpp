...
/*
 * v_1_0/edate/EdatePackageImpl.cpp
...
#include <v_1_0/edate/EdateFactory.hpp>
#include <ecore.hpp>
...
void EdatePackage::_initPackage()
{
    ...
    { // Feature FirstManOnMoonDate of class Apollo11
        ...
        feature->setFeatureID(
                ::v_1_0::edate::EdatePackage::APOLLO11__FIRSTMANONMOONDATE);
    ...
    { // Feature Member of class Apollo11
        ...
        feature->setFeatureID(::v_1_0::edate::EdatePackage::APOLLO11__MEMBER);
        feature->basicsetEContainingClass(m_Apollo11EClass);
    ...
    { // Feature Birthday of class Person
        ...
        feature->setFeatureID(::v_1_0::edate::EdatePackage::PERSON__BIRTHDAY);
    ...
    { // Feature Name of class Person
        ...
        feature->setFeatureID(::v_1_0::edate::EdatePackage::PERSON__NAME);
        feature->basicsetEContainingClass(m_PersonEClass);
    ...
    setName("edate");
    setNsPrefix("edate");
    setNsURI("http://www.example.org/edate/1.0");
