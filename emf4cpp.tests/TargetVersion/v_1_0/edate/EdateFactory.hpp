...
#ifndef _V_1_0_EDATEFACTORY_HPP
#define _V_1_0_EDATEFACTORY_HPP
...
namespace v_1_0
{
    namespace edate
    {
        ...
        class EXPORT_V_1_0_EDATE_DLL EdateFactory : public virtual ::ecore::EFactory
        {
        public:
