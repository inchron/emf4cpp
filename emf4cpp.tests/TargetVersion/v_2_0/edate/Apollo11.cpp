...
#include <v_2_0/edate/Person.hpp>
...
::v_2_0::edate::Person_ptr Apollo11::getMember() const
{
    return m_Member;
}

void Apollo11::setMember(::v_2_0::edate::Person_ptr _Member)
{
    if (m_Member)
...
#ifdef ECORECPP_NOTIFICATION_API
    ::v_2_0::edate::Person_ptr _old_Member = m_Member;
#endif
    m_Member = _Member;
