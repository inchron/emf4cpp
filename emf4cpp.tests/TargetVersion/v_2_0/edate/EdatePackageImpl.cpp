...
#include <v_2_0/edate/EdatePackage.hpp>
...
void EdatePackage::_initPackage()
{
    ...
    { // Feature Member of class Apollo11
        ...
        feature->setFeatureID(::v_2_0::edate::EdatePackage::APOLLO11__MEMBER);
        feature->basicsetEContainingClass(m_Apollo11EClass);
    ...
    { // Feature Birthday of class Person
        ...
        feature->setFeatureID(::v_2_0::edate::EdatePackage::PERSON__BIRTHDAY);
    ...
    { // Feature Name of class Person
        ...
        feature->setFeatureID(::v_2_0::edate::EdatePackage::PERSON__NAME);
        feature->basicsetEContainingClass(m_PersonEClass);
    ...
    setName("edate");
    setNsPrefix("edate");
    setNsURI("http://www.example.org/edate/2.0");
