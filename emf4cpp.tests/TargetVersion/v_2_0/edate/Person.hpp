...
#ifndef V_2_0_EDATE_PERSON_HPP
#define V_2_0_EDATE_PERSON_HPP
...
namespace v_2_0
{
    ...
    class EXPORT_V_2_0_EDATE_DLL Person : public virtual ::ecore::EObject
    {
    public:
        Person();
