...
#ifndef KDM_PLATFORM_PROCESS_HPP
#define KDM_PLATFORM_PROCESS_HPP
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Process : public virtual ::kdm::platform::RuntimeResource
    {
    public:
        Process();
        ...
        static const int classifierId = PlatformPackage::PROCESS;
...
#endif // KDM_PLATFORM_PROCESS_HPP
