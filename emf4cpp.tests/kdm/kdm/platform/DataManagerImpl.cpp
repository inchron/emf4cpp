...
/*PROTECTED REGION ID(DataManagerImpl.cpp) START*/
...
void DataManager::_initialize()
{
    ...
    /*PROTECTED REGION ID(DataManagerImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject DataManager::eGet(::ecore::EInt _featureID,
...
void DataManager::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean DataManager::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::platform::PlatformPackage::DATAMANAGER__ATTRIBUTE:
...
void DataManager::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void DataManager::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void DataManager::_inverseRemove(::ecore::EInt _featureID,
