...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL LockResource : public virtual ::kdm::platform::ResourceType
    {
    public:
        LockResource();
        ...
        /*PROTECTED REGION ID(LockResourceImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/

    protected:
        LockResource_ptr _this()
        {   return std::dynamic_pointer_cast<LockResource>(shared_from_this());}
...
#endif // KDM_PLATFORM_LOCKRESOURCE_HPP
