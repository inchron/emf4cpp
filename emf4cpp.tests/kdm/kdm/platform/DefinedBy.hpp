...
/*PROTECTED REGION ID(DefinedBy_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL DefinedBy : public virtual ::kdm::action::AbstractActionRelationship
    {
    public:
        DefinedBy();
        ...
        static const int classifierId = PlatformPackage::DEFINEDBY;

        /*PROTECTED REGION ID(DefinedBy) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
        ...
        /*PROTECTED REGION ID(DefinedByImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // KDM_PLATFORM_DEFINEDBY_HPP
