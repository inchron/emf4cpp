...
void Machine::_initialize()
{
    ...
    // References
    for (const auto &ref : getDeployedComponent())
    {
        ref->_initialize();
    }
    for (const auto &ref : getDeployedResource())
    {
        ref->_initialize();
    }
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::kdm::platform::PlatformPackage::MACHINE__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__TAGGEDVALUE:
    {
        _any = getTaggedValue().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::kdm::core::String
                > ::toAny(_any, getName());
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__SOURCE:
    {
        _any = getSource().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__RELATION:
    {
        _any = getRelation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__ABSTRACTION:
    {
        _any = getAbstraction().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__IMPLEMENTATION:
    {
    ...
    {
        _any = getDeployedComponent().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDRESOURCE:
    {
        _any = getDeployedResource().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDCOMPONENT:
    {
        ...
        getDeployedComponent().insert_all(*_t0);
    }
        return;
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDRESOURCE:
    {
        ...
        getDeployedResource().insert_all(*_t0);
    }
        return;
...
::ecore::EBoolean Machine::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDCOMPONENT:
        return getDeployedComponent().size() > 0;
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDRESOURCE:
...
::ecore::EClass_ptr Machine::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::platform::PlatformPackage::_instance()->getMachine();
    return _eclass;
}

/** Set the local end of a reference with an EOpposite property.
 */
void Machine::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Machine::_inverseRemove(::ecore::EInt _featureID,
