...
/*PROTECTED REGION ID(DeployedSoftwareSystemImpl.cpp) START*/
...
void DeployedSoftwareSystem::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(DeployedSoftwareSystemImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject DeployedSoftwareSystem::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    {
        _any = getGroupedComponent().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
...
void DeployedSoftwareSystem::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::kdm::platform::PlatformPackage::DEPLOYEDSOFTWARESYSTEM__GROUPEDCOMPONENT:
    {
        ...
        getGroupedComponent().insert_all(*_t0);
    }
        return;
...
::ecore::EBoolean DeployedSoftwareSystem::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::platform::PlatformPackage::DEPLOYEDSOFTWARESYSTEM__ATTRIBUTE:
...
void DeployedSoftwareSystem::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void DeployedSoftwareSystem::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void DeployedSoftwareSystem::_inverseRemove(::ecore::EInt _featureID,
