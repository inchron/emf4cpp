...
namespace kdm
{
    ...
    public:
        ...
        static const int classifierId = PlatformPackage::SPAWNS;
    ...
    protected:
        Spawns_ptr _this()
        {   return std::dynamic_pointer_cast<Spawns>(shared_from_this());}

        // Attributes

        // References

        std::weak_ptr< ::kdm::platform::RuntimeResource > m_to;
