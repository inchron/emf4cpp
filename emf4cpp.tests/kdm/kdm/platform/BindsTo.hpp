...
namespace kdm
{
    ...
    public:
        ...
        static const int classifierId = PlatformPackage::BINDSTO;
    ...
    protected:
        BindsTo_ptr _this()
        {   return std::dynamic_pointer_cast<BindsTo>(shared_from_this());}
        ...
        std::weak_ptr< ::kdm::platform::ResourceType > m_from;
