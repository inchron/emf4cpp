...
namespace kdm
{
    ...
    public:
        ...
        // References
        virtual ::kdm::code::ControlElement_ptr getTo () const;
        virtual void setTo (::kdm::code::ControlElement_ptr _to);
        ...
        static const int classifierId = ActionPackage::CALLS;
    ...
    protected:
        Calls_ptr _this()
        {   return std::dynamic_pointer_cast<Calls>(shared_from_this());}

        // Attributes

        // References

        std::weak_ptr< ::kdm::code::ControlElement > m_to;
