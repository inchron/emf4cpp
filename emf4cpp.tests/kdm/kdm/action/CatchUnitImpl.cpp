...
/*PROTECTED REGION ID(CatchUnitImpl.cpp) START*/
...
void CatchUnit::_initialize()
{
    ...
    /*PROTECTED REGION ID(CatchUnitImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject CatchUnit::eGet(::ecore::EInt _featureID,
...
void CatchUnit::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean CatchUnit::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::action::ActionPackage::CATCHUNIT__ATTRIBUTE:
...
void CatchUnit::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void CatchUnit::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void CatchUnit::_inverseRemove(::ecore::EInt _featureID,
