...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Creates : public virtual ::kdm::action::AbstractActionRelationship
    {
    public:
        Creates();
        ...
        static const int classifierId = ActionPackage::CREATES;
    ...
    protected:
        Creates_ptr _this()
        {   return std::dynamic_pointer_cast<Creates>(shared_from_this());}
