...
/*PROTECTED REGION ID(TrueFlowImpl.cpp) START*/
...
// EObject
::ecore::EJavaObject TrueFlow::eGet(::ecore::EInt _featureID,
...
void TrueFlow::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean TrueFlow::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::action::ActionPackage::TRUEFLOW__ATTRIBUTE:
...
void TrueFlow::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void TrueFlow::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void TrueFlow::_inverseRemove(::ecore::EInt _featureID,
