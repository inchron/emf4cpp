...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL ExceptionFlow : public virtual ::kdm::action::AbstractActionRelationship
    {
    public:
        ExceptionFlow();

        ~ExceptionFlow() override;
    ...
    protected:
        ExceptionFlow_ptr _this()
        {   return std::dynamic_pointer_cast<ExceptionFlow>(shared_from_this());}
