...
/*PROTECTED REGION ID(Calls.cpp) START*/
...
void Calls::setTo(::kdm::code::ControlElement_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ::kdm::code::ControlElement_ptr _old_to = m_to.lock();
#endif
    m_to = _to;
...
void Calls::setFrom(::kdm::action::ActionElement_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
