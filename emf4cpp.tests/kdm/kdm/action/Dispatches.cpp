...
/*PROTECTED REGION ID(Dispatches.cpp) START*/
...
void Dispatches::setTo(::kdm::code::DataElement_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::kdm::action::ActionPackage::_instance()->getDispatches__to(),
                _old_to,
                m_to.lock()
            );
...
void Dispatches::setFrom(::kdm::action::ActionElement_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                _this(),
                ::kdm::action::ActionPackage::_instance()->getDispatches__from(),
                _old_from,
                m_from.lock()
            );
        eNotify(&notification);
