...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL AbstractDataRelationship : public virtual ::kdm::core::KDMRelationship
    {
    public:
        AbstractDataRelationship();

        ~AbstractDataRelationship() override;
        ...
        /*PROTECTED REGION ID(AbstractDataRelationshipImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // KDM_DATA_ABSTRACTDATARELATIONSHIP_HPP
