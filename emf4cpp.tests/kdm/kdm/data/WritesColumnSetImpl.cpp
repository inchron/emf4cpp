...
// EObject
::ecore::EJavaObject WritesColumnSet::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ::ecore::EJavaObject _any;
    switch (_featureID)
    {
    case ::kdm::data::DataPackage::WRITESCOLUMNSET__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::WRITESCOLUMNSET__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::WRITESCOLUMNSET__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::WRITESCOLUMNSET__TAGGEDVALUE:
    {
...
void WritesColumnSet::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean WritesColumnSet::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::data::DataPackage::WRITESCOLUMNSET__ATTRIBUTE:
...
void WritesColumnSet::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr WritesColumnSet::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::data::DataPackage::_instance()->getWritesColumnSet();
    return _eclass;
}
