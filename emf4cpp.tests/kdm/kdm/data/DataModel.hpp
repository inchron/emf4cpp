...
namespace kdm
{
    ...
    public:
        ...
        // References
        virtual const ::ecorecpp::mapping::EList< ::kdm::data::AbstractDataElement_ptr >& getDataElement () const;
        virtual ::ecorecpp::mapping::EList< ::kdm::data::AbstractDataElement_ptr >& getDataElement ();
