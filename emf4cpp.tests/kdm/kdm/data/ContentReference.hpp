...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL ContentReference : public virtual ::kdm::data::ContentItem
    {
    public:
        ContentReference();
        ...
        static const int classifierId = DataPackage::CONTENTREFERENCE;
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<ContentReference>(shared_from_this());}
