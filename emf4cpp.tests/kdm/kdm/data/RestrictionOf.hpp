...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL RestrictionOf : public virtual ::kdm::data::AbstractDataRelationship
    {
    public:
        RestrictionOf();

        ~RestrictionOf() override;
        ...
        static const int classifierId = DataPackage::RESTRICTIONOF;
    ...
    protected:
        RestrictionOf_ptr _this()
        {   return std::dynamic_pointer_cast<RestrictionOf>(shared_from_this());}
