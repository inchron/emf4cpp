        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::kdm::data::DataPackage::KEYRELATION__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::KEYRELATION__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::KEYRELATION__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::data::DataPackage::KEYRELATION__TAGGEDVALUE:
    {
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::kdm::data::DataPackage::KEYRELATION__TO:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::kdm::data::UniqueKey > (_t0);
        setTo(_t1);
    }
        return;
    case ::kdm::data::DataPackage::KEYRELATION__FROM:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::kdm::data::ReferenceKey > (_t0);
        setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr KeyRelation::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::data::DataPackage::_instance()->getKeyRelation();
    return _eclass;
}
