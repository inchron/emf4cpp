...
/*PROTECTED REGION ID(ImplementationOf.cpp) START*/
...
void ImplementationOf::setTo(::kdm::code::CodeItem_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::kdm::code::CodePackage::_instance()->getImplementationOf__to(),
                _old_to,
                m_to.lock()
            );
...
void ImplementationOf::setFrom(::kdm::code::CodeItem_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                _this(),
                ::kdm::code::CodePackage::_instance()->getImplementationOf__from(),
                _old_from,
                m_from.lock()
            );
        eNotify(&notification);
