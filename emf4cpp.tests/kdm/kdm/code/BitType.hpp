...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL BitType : public virtual ::kdm::code::PrimitiveType
    {
    public:
        BitType();
        ...
        static const int classifierId = CodePackage::BITTYPE;
    ...
    protected:
        BitType_ptr _this()
        {   return std::dynamic_pointer_cast<BitType>(shared_from_this());}
