...
/*PROTECTED REGION ID(SignatureImpl.cpp) START*/
...
// EObject
::ecore::EJavaObject Signature::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    {
        _any = getParameterUnit().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::kdm::code::CodePackage::SIGNATURE__PARAMETERUNIT:
    {
        ...
        getParameterUnit().insert_all(*_t0);
    }
        return;
 ...
 */
void Signature::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Signature::_inverseRemove(::ecore::EInt _featureID,
