...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL CommentUnit : public virtual ::kdm::core::ModelElement
    {
    public:
        CommentUnit();

        ~CommentUnit() override;
        ...
        static const int classifierId = CodePackage::COMMENTUNIT;
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<CommentUnit>(shared_from_this());}
