...
#ifndef KDM_CODE_MACROUNIT_HPP
#define KDM_CODE_MACROUNIT_HPP
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL MacroUnit : public virtual ::kdm::code::PreprocessorDirective
    {
    public:
        MacroUnit();
        ...
        static const int classifierId = CodePackage::MACROUNIT;
        ...
        /*PROTECTED REGION ID(MacroUnitImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
    ...
    protected:
        MacroUnit_ptr _this()
        {   return std::dynamic_pointer_cast<MacroUnit>(shared_from_this());}
