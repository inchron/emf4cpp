...
/*PROTECTED REGION ID(CodeModel_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL CodeModel : public virtual ::kdm::kdm::KDMModel
    {
    public:
        CodeModel();
        ...
        static const int classifierId = CodePackage::CODEMODEL;
        ...
        /*PROTECTED REGION ID(CodeModelImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
