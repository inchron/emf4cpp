        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::kdm::code::CodePackage::GENERATEDFROM__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::GENERATEDFROM__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::GENERATEDFROM__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::GENERATEDFROM__TAGGEDVALUE:
    {
...
::ecore::EClass_ptr GeneratedFrom::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::code::CodePackage::_instance()->getGeneratedFrom();
    return _eclass;
}

/** Set the local end of a reference with an EOpposite property.
 */
void GeneratedFrom::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void GeneratedFrom::_inverseRemove(::ecore::EInt _featureID,
