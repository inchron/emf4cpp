...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL AbstractCodeRelationship : public virtual ::kdm::core::KDMRelationship
    {
    public:
        AbstractCodeRelationship();

        ~AbstractCodeRelationship() override;
        ...
        static const int classifierId = CodePackage::ABSTRACTCODERELATIONSHIP;
        ...
        /*PROTECTED REGION ID(AbstractCodeRelationshipImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
