...
/*PROTECTED REGION ID(VisibleIn_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL VisibleIn : public virtual ::kdm::code::AbstractCodeRelationship
    {
    public:
        VisibleIn();
        ...
        static const int classifierId = CodePackage::VISIBLEIN;

        /*PROTECTED REGION ID(VisibleIn) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
        ...
        /*PROTECTED REGION ID(VisibleInImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
