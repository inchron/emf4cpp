...
/*PROTECTED REGION ID(RangeTypeImpl.cpp) START*/
...
void RangeType::_initialize()
{
    ...
    /*PROTECTED REGION ID(RangeTypeImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject RangeType::eGet(::ecore::EInt _featureID,
 ...
 */
void RangeType::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void RangeType::_inverseRemove(::ecore::EInt _featureID,
