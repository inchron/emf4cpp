...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL BagType : public virtual ::kdm::code::DerivedType
    {
    public:
        BagType();
        ...
        /*PROTECTED REGION ID(BagTypeImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
    ...
    protected:
        BagType_ptr _this()
        {   return std::dynamic_pointer_cast<BagType>(shared_from_this());}
