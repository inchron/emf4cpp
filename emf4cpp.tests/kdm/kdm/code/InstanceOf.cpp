...
void InstanceOf::setTo(::kdm::code::TemplateUnit_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ::kdm::code::TemplateUnit_ptr _old_to = m_to.lock();
#endif
    m_to = _to;
...
void InstanceOf::setFrom(::kdm::code::AbstractCodeElement_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
