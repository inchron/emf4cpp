...
#ifndef KDM_CODE_VALUE_HPP
#define KDM_CODE_VALUE_HPP
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Value : public virtual ::kdm::code::ValueElement
    {
    public:
        Value();
        ...
        static const int classifierId = CodePackage::VALUE;
