...
/*PROTECTED REGION ID(AbstractCodeElementImpl.cpp) START*/
...
void AbstractCodeElement::_initialize()
{
    // Supertypes
    ...
    for (const auto &ref : getComment())
    {
        ref->_initialize();
    }
    for (const auto &ref : getCodeRelation())
    {
        ref->_initialize();
    }
...
// EObject
::ecore::EJavaObject AbstractCodeElement::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ::ecore::EJavaObject _any;
    switch (_featureID)
    {
    case ::kdm::code::CodePackage::ABSTRACTCODEELEMENT__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::ABSTRACTCODEELEMENT__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::ABSTRACTCODEELEMENT__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::ABSTRACTCODEELEMENT__TAGGEDVALUE:
    {
        _any = getTaggedValue().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::code::CodePackage::ABSTRACTCODEELEMENT__NAME:
    {
 ...
 */
void AbstractCodeElement::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void AbstractCodeElement::_inverseRemove(::ecore::EInt _featureID,
