...
/*PROTECTED REGION ID(InstanceOf_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL InstanceOf : public virtual ::kdm::code::AbstractCodeRelationship
    {
    public:
        InstanceOf();
        ...
        static const int classifierId = CodePackage::INSTANCEOF;
        ...
        /*PROTECTED REGION ID(InstanceOfImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
