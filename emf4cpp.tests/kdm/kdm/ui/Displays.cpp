...
/*PROTECTED REGION ID(Displays.cpp) START*/
...
void Displays::setTo(::kdm::ui::UIResource_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::kdm::ui::UiPackage::_instance()->getDisplays__to(),
                _old_to,
                m_to.lock()
            );
...
void Displays::setFrom(::kdm::action::ActionElement_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                _this(),
                ::kdm::ui::UiPackage::_instance()->getDisplays__from(),
                _old_from,
                m_from.lock()
            );
        eNotify(&notification);
