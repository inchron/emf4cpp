...
/*PROTECTED REGION ID(UIResource_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL UIResource : public virtual ::kdm::ui::AbstractUIElement
    {
    public:
        UIResource();
        ...
        static const int classifierId = UiPackage::UIRESOURCE;
        ...
        /*PROTECTED REGION ID(UIResourceImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
