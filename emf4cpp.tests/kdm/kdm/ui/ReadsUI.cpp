...
void ReadsUI::setTo(::kdm::ui::UIResource_ptr _to)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::kdm::ui::UiPackage::_instance()->getReadsUI__to(),
                _old_to,
                m_to.lock()
            );
...
void ReadsUI::setFrom(::kdm::action::ActionElement_ptr _from)
{
#ifdef ECORECPP_NOTIFICATION_API
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                _this(),
                ::kdm::ui::UiPackage::_instance()->getReadsUI__from(),
                _old_from,
                m_from.lock()
            );
        eNotify(&notification);
