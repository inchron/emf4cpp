...
namespace kdm
{
    ...
    public:
        ...
        static const int classifierId = SourcePackage::RESOURCEDESCRIPTION;
    ...
    protected:
        ResourceDescription_ptr _this()
        {   return std::dynamic_pointer_cast<ResourceDescription>(shared_from_this());}
