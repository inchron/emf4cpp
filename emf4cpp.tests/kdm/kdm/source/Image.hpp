...
#ifndef KDM_SOURCE_IMAGE_HPP
#define KDM_SOURCE_IMAGE_HPP
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Image : public virtual ::kdm::source::InventoryItem
    {
    public:
        Image();
        ...
        static const int classifierId = SourcePackage::IMAGE;
