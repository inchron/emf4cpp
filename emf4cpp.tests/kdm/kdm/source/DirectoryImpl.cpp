...
/*PROTECTED REGION ID(DirectoryImpl.cpp) START*/
...
void Directory::_initialize()
{
    ...
    /*PROTECTED REGION ID(DirectoryImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject Directory::eGet(::ecore::EInt _featureID,
 ...
 */
void Directory::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Directory::_inverseRemove(::ecore::EInt _featureID,
