...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL BinaryFile : public virtual ::kdm::source::InventoryItem
    {
    public:
        BinaryFile();
        ...
        /*PROTECTED REGION ID(BinaryFileImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<BinaryFile>(shared_from_this());}
...
#endif // KDM_SOURCE_BINARYFILE_HPP
