    ...
    namespace source
    {
        ...
        public:
            ...
            void enter(const ::ecore::EObject_ptr &obj)
            {
                ...
                {
                    auto derived = ::ecore::as < AbstractInventoryElement
                            > (obj);
                    _this()->T::work(derived,
                            (AbstractInventoryElement*) nullptr);
                }
                    break;
                case SourcePackage::ABSTRACTINVENTORYRELATIONSHIP:
                {
                    auto derived = ::ecore::as < AbstractInventoryRelationship
                            > (obj);
                    _this()->T::work(derived,
                            (AbstractInventoryRelationship*) nullptr);
                }
                    break;
