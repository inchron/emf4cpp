...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL AbstractInventoryRelationship : public virtual ::kdm::core::KDMRelationship
    {
    public:
        AbstractInventoryRelationship();

        ~AbstractInventoryRelationship() override;
        ...
        /*PROTECTED REGION ID(AbstractInventoryRelationshipImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<AbstractInventoryRelationship>(shared_from_this());}
...
#endif // KDM_SOURCE_ABSTRACTINVENTORYRELATIONSHIP_HPP
