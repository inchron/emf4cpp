...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Configuration : public virtual ::kdm::source::InventoryItem
    {
    public:
        Configuration();
        ...
        static const int classifierId = SourcePackage::CONFIGURATION;
...
#endif // KDM_SOURCE_CONFIGURATION_HPP
