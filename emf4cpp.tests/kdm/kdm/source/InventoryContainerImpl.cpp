...
/*PROTECTED REGION ID(InventoryContainerImpl.cpp) START*/
...
void InventoryContainer::_initialize()
{
    // Supertypes
...
// EObject
::ecore::EJavaObject InventoryContainer::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ::ecore::EJavaObject _any;
    switch (_featureID)
    {
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__TAGGEDVALUE:
    {
        _any = getTaggedValue().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::kdm::core::String
                > ::toAny(_any, getName());
    }
        return _any;
    case ::kdm::source::SourcePackage::INVENTORYCONTAINER__INVENTORYRELATION:
    {
...
::ecore::EClass_ptr InventoryContainer::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::source::SourcePackage::_instance()->getInventoryContainer();
    return _eclass;
}

/** Set the local end of a reference with an EOpposite property.
 */
void InventoryContainer::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void InventoryContainer::_inverseRemove(::ecore::EInt _featureID,
