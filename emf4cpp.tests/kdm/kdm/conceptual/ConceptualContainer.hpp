...
/*PROTECTED REGION ID(ConceptualContainer_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL ConceptualContainer : public virtual ::kdm::conceptual::AbstractConceptualElement
    {
    public:
        ConceptualContainer();

        ~ConceptualContainer() override;
        ...
        static const int classifierId = ConceptualPackage::CONCEPTUALCONTAINER;
        ...
        /*PROTECTED REGION ID(ConceptualContainerImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
