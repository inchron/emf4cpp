...
/*PROTECTED REGION ID(ScenarioUnitImpl.cpp) START*/
...
// EObject
::ecore::EJavaObject ScenarioUnit::eGet(::ecore::EInt _featureID,
...
void ScenarioUnit::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean ScenarioUnit::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::conceptual::ConceptualPackage::SCENARIOUNIT__ATTRIBUTE:
...
void ScenarioUnit::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void ScenarioUnit::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void ScenarioUnit::_inverseRemove(::ecore::EInt _featureID,
