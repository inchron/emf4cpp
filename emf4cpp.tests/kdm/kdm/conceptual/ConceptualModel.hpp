...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL ConceptualModel : public virtual ::kdm::kdm::KDMModel
    {
    public:
        ConceptualModel();

        ~ConceptualModel() override;
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<ConceptualModel>(shared_from_this());}
