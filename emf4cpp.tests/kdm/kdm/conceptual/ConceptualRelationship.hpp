...
namespace kdm
{
    ...
    public:
        ...
        ~ConceptualRelationship() override;
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<ConceptualRelationship>(shared_from_this());}
        ...
        std::weak_ptr< ::kdm::conceptual::AbstractConceptualElement > m_from;
