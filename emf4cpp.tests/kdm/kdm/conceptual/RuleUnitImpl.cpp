...
/*PROTECTED REGION ID(RuleUnitImpl.cpp) START*/
...
void RuleUnit::_initialize()
{
    ...
    /*PROTECTED REGION ID(RuleUnitImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
void RuleUnit::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean RuleUnit::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::conceptual::ConceptualPackage::RULEUNIT__ATTRIBUTE:
...
void RuleUnit::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void RuleUnit::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void RuleUnit::_inverseRemove(::ecore::EInt _featureID,
