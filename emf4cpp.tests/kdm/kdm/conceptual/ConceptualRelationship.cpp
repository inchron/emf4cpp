...
void ConceptualRelationship::setTo(::kdm::core::KDMEntity_ptr _to)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                _this(),
                ::kdm::conceptual::ConceptualPackage::_instance()->getConceptualRelationship__to(),
                _old_to,
                m_to.lock()
            );
...
{
#ifdef ECORECPP_NOTIFICATION_API
    ::kdm::conceptual::AbstractConceptualElement_ptr _old_from = m_from.lock();
#endif
    m_from = _from;
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                _this(),
                ::kdm::conceptual::ConceptualPackage::_instance()->getConceptualRelationship__from(),
                _old_from,
                m_from.lock()
            );
        eNotify(&notification);
