...
/*PROTECTED REGION ID(TaggedRef_pre) START*/
...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL TaggedRef : public virtual ::kdm::kdm::ExtendedValue
    {
    public:
        TaggedRef();
        ...
        static const int classifierId = KdmPackage::TAGGEDREF;
        ...
        /*PROTECTED REGION ID(TaggedRefImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
