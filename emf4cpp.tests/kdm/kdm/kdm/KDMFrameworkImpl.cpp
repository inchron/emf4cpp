...
/*PROTECTED REGION ID(KDMFrameworkImpl.cpp) START*/
...
void KDMFramework::_initialize()
{
    // Supertypes
    ::kdm::core::ModelElement::_initialize();

    // References
    for (const auto &ref : getAudit())
    {
        ref->_initialize();
    }
    for (const auto &ref : getExtensionFamily())
    {
        ref->_initialize();
    }
...
// EObject
::ecore::EJavaObject KDMFramework::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean /*_resolve*/)
{
    ::ecore::EJavaObject _any;
    switch (_featureID)
    {
    case ::kdm::kdm::KdmPackage::KDMFRAMEWORK__ATTRIBUTE:
    {
        _any = getAttribute().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::kdm::KdmPackage::KDMFRAMEWORK__ANNOTATION:
    {
        _any = getAnnotation().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::kdm::KdmPackage::KDMFRAMEWORK__STEREOTYPE:
    {
        _any = getStereotype().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::kdm::KdmPackage::KDMFRAMEWORK__TAGGEDVALUE:
    {
...
::ecore::EClass_ptr KDMFramework::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::kdm::kdm::KdmPackage::_instance()->getKDMFramework();
    return _eclass;
}

/** Set the local end of a reference with an EOpposite property.
 */
void KDMFramework::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void KDMFramework::_inverseRemove(::ecore::EInt _featureID,
