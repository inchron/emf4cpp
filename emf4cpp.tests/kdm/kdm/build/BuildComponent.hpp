...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL BuildComponent : public virtual ::kdm::build::BuildResource
    {
    public:
        BuildComponent();

        ~BuildComponent() override;
        ...
        static const int classifierId = BuildPackage::BUILDCOMPONENT;
    ...
    protected:
        ...
        {   return std::dynamic_pointer_cast<BuildComponent>(shared_from_this());}
