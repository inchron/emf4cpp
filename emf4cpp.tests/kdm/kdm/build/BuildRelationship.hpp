...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL BuildRelationship : public virtual ::kdm::build::AbstractBuildRelationship
    {
    public:
        BuildRelationship();

        ~BuildRelationship() override;
        ...
        static const int classifierId = BuildPackage::BUILDRELATIONSHIP;
