...
/*PROTECTED REGION ID(BuildStepImpl.cpp) START*/
...
// EObject
::ecore::EJavaObject BuildStep::eGet(::ecore::EInt _featureID,
...
void BuildStep::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean BuildStep::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kdm::build::BuildPackage::BUILDSTEP__ATTRIBUTE:
...
void BuildStep::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void BuildStep::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void BuildStep::_inverseRemove(::ecore::EInt _featureID,
