...
/*PROTECTED REGION ID(SupplierImpl.cpp) START*/
...
void Supplier::_initialize()
{
    ...
    /*PROTECTED REGION ID(SupplierImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject Supplier::eGet(::ecore::EInt _featureID,
 ...
 */
void Supplier::_inverseAdd(::ecore::EInt _featureID,
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void Supplier::_inverseRemove(::ecore::EInt _featureID,
