    ...
    namespace structure
    {
        ...
        public:
            ...
            void enter(const ::ecore::EObject_ptr &obj)
            {
                ...
                {
                    auto derived = ::ecore::as < AbstractStructureElement
                            > (obj);
                    _this()->T::work(derived,
                            (AbstractStructureElement*) nullptr);
                }
                    break;
                case StructurePackage::ABSTRACTSTRUCTURERELATIONSHIP:
                {
                    auto derived = ::ecore::as < AbstractStructureRelationship
                            > (obj);
                    _this()->T::work(derived,
                            (AbstractStructureRelationship*) nullptr);
                }
                    break;
