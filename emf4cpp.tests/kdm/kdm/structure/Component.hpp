...
namespace kdm
{
    ...
    class EXPORT_KDM_DLL Component : public virtual ::kdm::structure::AbstractStructureElement
    {
    public:
        Component();
        ...
        static const int classifierId = StructurePackage::COMPONENT;
...
#endif // KDM_STRUCTURE_COMPONENT_HPP
