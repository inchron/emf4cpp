...
class EXPORT_IDLMM_DLL Field : public virtual ::idlmm::Typed
{
public:
    Field();
    ...
    static const int classifierId = IdlmmPackage::FIELD;
...
protected:
    Field_ptr _this()
    {   return std::dynamic_pointer_cast<Field>(shared_from_this());}
