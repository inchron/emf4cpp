...
namespace PrimitiveTypes
{
    ...
    class EXPORT_PRIMITIVETYPES_DLL PrimitiveTypesFactory : public virtual ::ecore::EFactory
    {
    public:

        static PrimitiveTypesFactory_ptr _instance();
        static void _setFactoryInstance(const PrimitiveTypesFactory_ptr&);
    ...
    protected:
        ...
        static ::ecore::Ptr< PrimitiveTypesFactory > s_holder;
