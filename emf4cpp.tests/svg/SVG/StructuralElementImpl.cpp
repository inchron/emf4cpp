...
/*PROTECTED REGION ID(StructuralElementImpl.cpp) START*/
...
void StructuralElement::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(StructuralElementImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject StructuralElement::eGet(::ecore::EInt _featureID,
...
void StructuralElement::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean StructuralElement::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::SVG::SVGPackage::STRUCTURALELEMENT__OWNER:
...
void StructuralElement::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
 ...
 */
void StructuralElement::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void StructuralElement::_inverseRemove(::ecore::EInt _featureID,
